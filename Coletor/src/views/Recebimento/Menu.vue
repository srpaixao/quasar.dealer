...
<template>
  <v-container class="text-center">
    <v-row dense>
      <v-col cols="12">
        <div class="text-center">Recebimento</div>
      </v-col>
    </v-row>
    <v-row justify="center">
      <v-col cols="12" md="4" sm="6">
        <v-btn block :to="{ name: 'Descarga' }" size="x-large" color="primary" variant="outlined">Descarregar</v-btn>
      </v-col>
    </v-row>

    <v-row justify="center">
      <v-col cols="12" md="4" sm="6">
        <v-btn block :to="{ name: 'Armazenar' }" size="x-large" color="primary" variant="outlined">Armazenar</v-btn>
      </v-col>
    </v-row>
  </v-container>
