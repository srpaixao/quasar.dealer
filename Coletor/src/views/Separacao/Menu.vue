...
<template>
  <v-container class="text-center">
    <v-row dense>
      <v-col cols="12">
          <div class="text-center">Separação</div>
        </v-col>
      </v-row>
    <v-row justify="center">
      <v-col cols="12" md="4" sm="6">
        <v-btn rounded="0" size="x-large" prepend-icon="" class="inactive-btn" block>Separar</v-btn>
      </v-col>
    </v-row>
    <v-row justify="center">
      <v-col cols="12" md="4" sm="6">
        <v-btn rounded="0" size="x-large" prepend-icon="" class="inactive-btn" block>Conferir</v-btn>
      </v-col>
    </v-row>
  </v-container>
