...
namespace Simplify.Quasar.Areas.ExpedicaoApp.ViewModels
{
    public class NotaFiscalViewModel
    {
        ...
        public string DataEmissaoTexto { get; set; }
        ...
        public bool ImprimirDireto { get; set; }
        public string ImpressoraPadraoNome { get; set; }
        public string ImpressoraPadraoIP { get; set; }
        public string ImpressoraPadraoPorta { get; set; }
    ...
    public class NotaFiscalTransportadoraImportViewModel
    {
        public int? TransportadoraId { get; set; }
        public IEnumerable<SelectListItem> TransportadoraDDL { get; set; }
    ...
    public class UploadArquivoTransportadora
    {
        public int? TransportadoraId { get; set; }
        public int? TipoMovimentoId { get; set; }
    ...
    public class NotaFiscalTransportadoraGridItemViewModel
    {
        public int Id { get; set; }
        ...
        public int? TipoMovimentoId { get; set; }
        public string NomeTipoMovimento { get; set; }
        public int? QtdVolumesDoc { get; set; }
    }
